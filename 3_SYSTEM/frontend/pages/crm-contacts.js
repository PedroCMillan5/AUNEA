...
// PURPOSE: Operate Contactos with optional Company scope, AUNEA dropdowns, active/inactive lifecycle,
//          structured roles, interaction capture and diagnostic actions.
// SOURCE: Reference IMG90-00-02 (governs composition, visible fields, order, controls and states under
//         DEC-056); DEC-061 (Spain-only schema, structured roles, inactivation); DEC-050; DEC-058 (last
//         interaction is derived); Architecture Contract v1.5 row P02.
