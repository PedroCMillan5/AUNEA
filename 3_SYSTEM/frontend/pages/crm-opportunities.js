...
//         Architecture Contract v1.2 row P04.
...
function opportunitiesPage() {
  const all = (state.opportunities || []).slice()
  ...
  const main = all.length
    ...
    : `<div class="empty"><h2>Sin oportunidades</h2><p>Una oportunidad es el caso comercial, separado de la persona. Una misma persona puede participar en varias sin duplicarse (DEC-042/051).</p></div>`;
