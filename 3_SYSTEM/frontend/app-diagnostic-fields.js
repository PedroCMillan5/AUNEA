...
function diagnosticFieldMeta(f){return `<span class="canonical-id">${f.Field_ID}</span>${f.Requiredness==='REQUIRED_90M'?'<span class="required-dot" title="Obligatoria"></span>':''}`}
